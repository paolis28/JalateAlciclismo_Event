...
class EventRepository(EventRepositoryPort):
    ...
    def create_event(self, event_data: Event):
        ...
        query = text("""
            INSERT INTO evento (id_usuario, nombre, descripcion, cantidad_participantes, origen_carrera, destino_fin_carrera, km, url_banner, fecha_evento, hora_evento, estatus)
            VALUES (:id_usuario, :nombre, :descripcion, :cantidad_participantes, :origen_carrera, :destino_fin_carrera, :km, :url_banner, :fecha_evento, :hora_evento, :estatus)
        """)
