...
class EventDependencyContainer:
    ...
    def get_get_events_by_user_use_case(self) -> GetEventsByUserUseCase:
...
def get_get_events_by_user_use_case_dependency() -> GetEventsByUserUseCase:
    """Dependencia para inyectar el caso de uso de obtener eventos por usuario"""
    container = get_dependency_container()
    return container.get_get_events_by_user_use_case()
